...
public class MyMain_Array1_초기화 {
	public static void main(String[] args) {
		...
		MyArrays1.display(fdsakjflkasjdflkasjdhnflkjsd_1);
		MyArrays1.display(fdsakjflkasjdflkasjdhnflkjsd_2);

		//정렬하기
		int [] fdsakjflkasjdflkasjdhnflkjsd_3=  {3,1,5,2,4};
		System.out.println("---[before sort]---");
		MyArrays1.display(fdsakjflkasjdflkasjdhnflkjsd_3);
		...
		MyArrays1.sort_asc(fdsakjflkasjdflkasjdhnflkjsd_4);
		MyArrays1.display(fdsakjflkasjdflkasjdhnflkjsd_4);
		
		
		System.out.println("---[after desc sort]---");
		int [] fdsakjflkasjdflkasjdhnflkjsd_5=  {3,1,5,2,4};
		MyArrays1.sort_desc(fdsakjflkasjdflkasjdhnflkjsd_5);
		MyArrays1.display(fdsakjflkasjdflkasjdhnflkjsd_5);
		...
		MyArrays1.sort_asc(fdsakjflkasjdflkasjdhnflkjsd_6, 1, 4);
		MyArrays1.display(fdsakjflkasjdflkasjdhnflkjsd_6);
		
		MyArrays1.sort_desc(fdsakjflkasjdflkasjdhnflkjsd_6, 1, 4);
		MyArrays1.display(fdsakjflkasjdflkasjdhnflkjsd_6);
		
		System.out.println("---[after asc(bubble) sort]---");
		MyArrays1.bubble_sort_asc(fdsakjflkasjdflkasjdhnflkjsd_6);
		MyArrays1.display(fdsakjflkasjdflkasjdhnflkjsd_6);
		
		System.out.println("---[after desc(bubble) sort]---");
		MyArrays1.bubble_sort_desc(fdsakjflkasjdflkasjdhnflkjsd_6);
		MyArrays1.display(fdsakjflkasjdflkasjdhnflkjsd_6);
